...
export default function Page(){return <PortalShell type="artist"><div className="moduleShell"><p className="portalType">ARTIST PORTAL</p><h1>Projects</h1><StatGrid items={['Upcoming Session','Active Projects','Files Awaiting Review','Billing Status']}/><Progress steps={artistProject.steps} current={artistProject.current}/></div></PortalShell>}
